...
use app\models\OfertaContentForm;
...
<!--        <li class="footer-config-tab-label"><a href="#footer-config" data-toggle="tab">Нижняя часть сайта</a></li>-->
        ...
        <li class="oferta-config-tab-label"><a href="#oferta-config" data-toggle="tab">Оферта</a></li>
    </ul>
    ...
    <div class="tab-content site-config">
        ...
        <div class="tab-pane" id="oferta-config">
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">Оферта</div>
                        <div class="box-body">
                            <?php $ofertaForm = ActiveForm::begin([
                                'options' => ['method' => 'post', 'enctype'=>'multipart/form-data']
                            ]); ?>

                            <?= $ofertaForm->field($oferta, 'oferta_text')->widget(CKEditor::class) ?>
