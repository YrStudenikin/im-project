                    ...
                    <div class="single-footer">
                        ...
                        <div class="footer-content">
                            <div class="loc-address">
                                ...
                                <span><i class="fa fa-envelope-o"></i><a href="mailto:info@pptk-lnr.ru">info@pptk-lnr.ru</a></span>
...
<!--                                <li><a href="#">Delivery Information</a></li>-->
                                ...
                                <li><a href="<?=Url::to('/terms')?>" style="line-height: inherit; padding-bottom: 0.5vw">Политика конфиденциальности</a></li>
                                <li><a href="<?=Url::to('/oferta')?>" style="line-height: inherit">Информация на сайте не является публичной офертой</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
