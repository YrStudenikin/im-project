...
<head>
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-180791206-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-180791206-1');
    </script>
...
<?php if( Yii::$app->session->hasFlash('growl') ): ?>
    <?php

    $growlFlash = Yii::$app->session->getFlash('growl')[0];

    echo Growl::widget([
        'type' => $growlFlash['type'],
        'title' => $growlFlash['title'],
        'body' => $growlFlash['body'],
        'showSeparator' => true,
        'delay' => 1500,
        'pluginOptions' => [
            'icon_type'=>'image',
