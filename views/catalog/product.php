...
use app\widgets\SimilarProductWidget;
        ...
        <div class="row">
            ...
            <div class="col-lg-9">
                <div class="thubnail-desc fix">
                    ...
                    <div class="pro-price mtb-10">
                        <p>
                        <div class="price-block" style="max-width: 350px;border-bottom: 1px solid #e2e2e2;padding-bottom: 10px;">
                            <span class="price" style="font-weight: 600"><?=PriceHelper::format($product->price_new) ?></span>
                            <div class="mtb-2" style="color: #8b8b8b line-height: initial;">*цена за 1 ед.</div>
                        </div>
                        <?php if (isset($product->price_old)): ?>
                            <del class="prev-price"><?=PriceHelper::format($product->price_old) ?></del>
                        <?php endif;?>
                        </p>
                        <a class="add-cart mt-2" data-id="<?=$product->id?>">В корзину</a>
                    </div>
                    <p>
                        <span style="font-size: 12px; color: #4e555b">**Наличие товара и его стоимость уточняйте у менеджеров</span>
                    </p>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                ...
                <?= SimilarProductWidget::widget(['categoryId' => $product->category->id])?>
