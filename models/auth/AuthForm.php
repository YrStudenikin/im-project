...
class AuthForm extends Model
{
    ...
    public function rules()
    {
        return [
            ...
            ['agree', 'required',
                'on' => self::SCENARIO_SIGN_UP,
                'requiredValue' => 1,
                'message' => 'Вы не подтвердили соглашение с политикой конфиденциальности!'],
    ...
    public function scenarios()
    {
        return [
            ...
            self::SCENARIO_SIGN_UP => ['f_name','l_name', 'email','password_hash','password_repeat','phone', 'agree'],
